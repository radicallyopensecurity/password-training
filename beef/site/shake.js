...
if (function () {
    ...
    for (var f = 30, h = 30, g = 350, p = 350, y = "//localhost:8088/harlem-shake.mp3", w = "mw-harlem_shake_me", v = "im_first", b = ["im_drunk", "im_baked", "im_trippin", "im_blown"], k = "mw-strobe_light", C = "//localhost:8088/harlem-shake-style.css", E = "mw_added_css", _ = a(), N = s(), T = document.getElementsByTagName("*"), A = null, H = 0; H < T.length; H++) {
        var M = T[H]
        if (r(M) && d(M)) {
            A = M
            break
